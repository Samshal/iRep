...
<html>
  <head>
	...
	<?= 
	$this->Html->css('AdminLTE/_all-skins.min.css');
	?>
  ...
  <body class="skin-blue fixed sidebar-mini">
    ...
    <?= 
    $this->Html->script('AdminLTE/jquery.slimscroll.min');
    ?>
    <!-- FastClick -->
    <script src='../../plugins/fastclick/fastclick.min.js'></script>
    <?= 
    $this->Html->script('AdminLTE/fastclick.min');
    ?>
    <!-- AdminLTE App -->
    ...
    <?= 
    $this->Html->script('AdminLTE/demo');
    ?>
  </body>
</html>